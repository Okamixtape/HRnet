...
// Importing Header and NewEmployeeForm components
    ...
    <>
      ...
      <main className="homepage">
        <aside className="homepage__aside">
          <svg fill="#3E4E02" className="homepage__logo" height="300px" width="300px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" viewBox="-45.06 -45.06 540.73 540.73" space="preserve" transform="matrix(-1, 0, 0, 1, 0, 0)rotate(0)">
